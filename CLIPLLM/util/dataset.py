...
class SemData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # self.base_tmp_path = get_os_path_join(self.base_path, label_path.split('/')[-1])
        # self.base_tmp_path = os.path.join(self.base_path, label_path.split('/')[-1])
        # label_b = cv2.imread(self.base_tmp_path, cv2.IMREAD_GRAYSCALE)
        # label_b = cv2.imread(self.base_path, cv2.IMREAD_GRAYSCALE)
